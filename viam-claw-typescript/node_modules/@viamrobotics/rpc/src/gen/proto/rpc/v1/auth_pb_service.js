...
var ExternalAuthService = (function () {
  function ExternalAuthService() {}
  ExternalAuthService.serviceName = "proto.rpc.v1.ExternalAuthService";
  return ExternalAuthService;
}());

ExternalAuthService.AuthenticateTo = {
  methodName: "AuthenticateTo",
  service: ExternalAuthService,
  requestStream: false,
  responseStream: false,
  requestType: proto_rpc_v1_auth_pb.AuthenticateToRequest,
  responseType: proto_rpc_v1_auth_pb.AuthenticateToResponse
};

exports.ExternalAuthService = ExternalAuthService;

function ExternalAuthServiceClient(serviceHost, options) {
  this.serviceHost = serviceHost;
  this.options = options || {};
}

ExternalAuthServiceClient.prototype.authenticateTo = function authenticateTo(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(ExternalAuthService.AuthenticateTo, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
exports.ExternalAuthServiceClient = ExternalAuthServiceClient;
